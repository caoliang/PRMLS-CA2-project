...
img_data_file = '..\\..\\data\\ca2data.h5'
X_train_data, y_train_data, X_test_data, y_test_data = read_data_set(h5_file=img_data_file)
...
model.fit_generator(datagen.flow(trDat, trLbl, batch_size=10),
                    validation_data=(tsDat, tsLbl),
                    epochs=150, #originally 200
                    verbose=1,
